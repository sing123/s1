 ...
 * http://www.oschina.net/question/129540_80925
 */
public class Ping {

	public static void main(String[] args) throws UnknownHostException {
		Ping p = new Ping();
		String ip = "192.168.3.80";
		int port = 8015;
		System.out.println(System.getProperty("user.dir"));
//		p.isAddressAvailable(ip);
//		p.printReachableIP(InetAddress.getByName(ip), port);
		p.isReachable(InetAddress.getByName("127.0.0.1"), InetAddress.getByName(ip), port, 5000);
	}
